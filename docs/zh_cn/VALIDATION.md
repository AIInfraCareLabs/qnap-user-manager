...
[English](../VALIDATION.md) | [中文文档目录](README.md) | [中文 README](../../README-zh_cn.md)
...
20 份 Markdown 的默认英文、相对链接和中文 README 路由检查通过。源码包包含中文 README 和全部中文指南；wheel 元数据读取英文 README。68 项离线回归、Twine 与发行内容检查通过，本地构建仅用于验证，不覆盖已发布的 0.4.0。
